...
<div class="card">
  ...
  <div class="card-body py-3">
    ...
    <form method="POST" action="{{ url('dashboard/category') }}/{{$category->id}}" enctype="multipart/form-data" class="form_submit_model">
      @csrf
      {!! method_field('patch') !!}
    <div class="row">
      <div class="col-lg-6">
      ...
      <div class="col-lg-6">
        <div class="mb-3">
           ...
           <input type="text" class="form-control" name="pname" value="{{$category->parent_name}}">
        </div>
      </div>
    </div>
    <div class="row">
